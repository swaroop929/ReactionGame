...
module top ;
    ...
    CyControlReg_v1_80 SevenSeg_Reg (
        .clock(1'b0),
        .control_0(Net_18),
        .control_1(Net_19),
        .control_2(Net_20),
        ...
        .control_7(Net_25),
        .reset(1'b0));
    defparam SevenSeg_Reg.Bit0Mode = 0;
    defparam SevenSeg_Reg.Bit1Mode = 0;
    defparam SevenSeg_Reg.Bit2Mode = 0;
    defparam SevenSeg_Reg.Bit3Mode = 0;
    defparam SevenSeg_Reg.Bit4Mode = 0;
    defparam SevenSeg_Reg.Bit5Mode = 0;
    defparam SevenSeg_Reg.Bit6Mode = 0;
    defparam SevenSeg_Reg.Bit7Mode = 0;
    defparam SevenSeg_Reg.BitValue = 0;
    defparam SevenSeg_Reg.BusDisplay = 0;
    defparam SevenSeg_Reg.ExtrReset = 0;
    defparam SevenSeg_Reg.NumOutputs = 8;

	wire [0:0] tmpOE__Pin_7_seg_A_net;
	wire [0:0] tmpFB_0__Pin_7_seg_A_net;
	wire [0:0] tmpIO_0__Pin_7_seg_A_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_A_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e0f621ea-31af-4d14-934d-d330f344086c"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_A
		 (.oe(tmpOE__Pin_7_seg_A_net),
		  .y({Net_18}),
		  .fb({tmpFB_0__Pin_7_seg_A_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_A_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_7_seg_B_net;
	wire [0:0] tmpFB_0__Pin_7_seg_B_net;
	wire [0:0] tmpIO_0__Pin_7_seg_B_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_B_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_B_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("dd6660bd-a2b9-45e5-9621-f4ca6e994a11"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_B
		 (.oe(tmpOE__Pin_7_seg_B_net),
		  .y({Net_19}),
		  .fb({tmpFB_0__Pin_7_seg_B_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_B_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_7_seg_C_net;
	wire [0:0] tmpFB_0__Pin_7_seg_C_net;
	wire [0:0] tmpIO_0__Pin_7_seg_C_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_C_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_C_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e503629d-3a34-4302-89e4-5c4e3b3e324e"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_C
		 (.oe(tmpOE__Pin_7_seg_C_net),
		  .y({Net_20}),
		  .fb({tmpFB_0__Pin_7_seg_C_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_C_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_C_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_7_seg_D_net;
	wire [0:0] tmpFB_0__Pin_7_seg_D_net;
	wire [0:0] tmpIO_0__Pin_7_seg_D_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_D_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_D_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fa8fd02d-f1b5-4ac8-a406-4b164f05db6d"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_D
		 (.oe(tmpOE__Pin_7_seg_D_net),
		  .y({Net_21}),
		  .fb({tmpFB_0__Pin_7_seg_D_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_D_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_D_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_D_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_D_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_7_seg_E_net;
	wire [0:0] tmpFB_0__Pin_7_seg_E_net;
	wire [0:0] tmpIO_0__Pin_7_seg_E_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_E_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_E_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d0c25dcd-a788-4117-a49f-78f1ab236ad3"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_E
		 (.oe(tmpOE__Pin_7_seg_E_net),
		  .y({Net_22}),
		  .fb({tmpFB_0__Pin_7_seg_E_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_E_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_E_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_E_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_E_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_7_seg_F_net;
	wire [0:0] tmpFB_0__Pin_7_seg_F_net;
	wire [0:0] tmpIO_0__Pin_7_seg_F_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_F_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_F_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9c098e67-24ac-48c3-9193-db75d4635137"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_F
		 (.oe(tmpOE__Pin_7_seg_F_net),
		  .y({Net_23}),
		  .fb({tmpFB_0__Pin_7_seg_F_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_F_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_F_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_F_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_F_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_7_seg_G_net;
	wire [0:0] tmpFB_0__Pin_7_seg_G_net;
	wire [0:0] tmpIO_0__Pin_7_seg_G_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_G_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_G_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8416528f-99c3-4b8b-b951-a5cee76b7557"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_G
		 (.oe(tmpOE__Pin_7_seg_G_net),
		  .y({Net_24}),
		  .fb({tmpFB_0__Pin_7_seg_G_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_G_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_G_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_G_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_G_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_7_seg_DP_net;
	wire [0:0] tmpFB_0__Pin_7_seg_DP_net;
	wire [0:0] tmpIO_0__Pin_7_seg_DP_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7_seg_DP_net;
	electrical [0:0] tmpSIOVREF__Pin_7_seg_DP_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0d8aba0f-69b0-4781-bdec-482272ee418d"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_7_seg_DP
		 (.oe(tmpOE__Pin_7_seg_DP_net),
		  .y({Net_25}),
		  .fb({tmpFB_0__Pin_7_seg_DP_net[0:0]}),
		  .io({tmpIO_0__Pin_7_seg_DP_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_7_seg_DP_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7_seg_DP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7_seg_DP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("c7663d5d-9e8f-4b51-a880-aa19c45ba3f1"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    Timer_v2_80_7 Timer_3secs (
        .capture(1'b0),
        .capture_out(Net_1710),
        .clock(Net_10),
        .enable(1'b1),
        .interrupt(Net_1712),
        .reset(Net_12),
        .tc(Net_1713),
        .trigger(1'b1));
    defparam Timer_3secs.CaptureCount = 2;
    defparam Timer_3secs.CaptureCounterEnabled = 0;
    defparam Timer_3secs.DeviceFamily = "PSoC5";
    defparam Timer_3secs.InterruptOnCapture = 0;
    defparam Timer_3secs.InterruptOnTC = 1;
    defparam Timer_3secs.Resolution = 16;
    defparam Timer_3secs.SiliconRevision = "0";
