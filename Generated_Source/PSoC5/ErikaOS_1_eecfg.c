 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_arcadian) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_5msec) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 5))
    #define TASK_6_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_2secs) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 6))
    #define TASK_7_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_7[TASK_7_STACK_SIZE];	/* Task 7 (tsk_yellow) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_arcadian*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_5msec*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_2secs*/
        #endif
        #ifdef TASK_7_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_7[(TASK_7_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_yellow*/
        #endif
        #ifdef TASK_8_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 4
    DeclareTask(tsk_5msec);
    #endif
    #if EE_MAX_TASK > 5
    DeclareTask(tsk_2secs);
    #endif
    #if EE_MAX_TASK > 6
    DeclareTask(tsk_yellow);
    #endif
    #if EE_MAX_TASK > 7
    DeclareTask(Task_8);
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread tsk_5msec */
    #endif
    #if EE_MAX_TASK > 5
        ,&EE_oo_thread_stub      /* thread tsk_2secs */
    #endif
    #if EE_MAX_TASK > 6
        ,&EE_oo_thread_stub      /* thread tsk_yellow */
    #endif
    #if EE_MAX_TASK > 7      
