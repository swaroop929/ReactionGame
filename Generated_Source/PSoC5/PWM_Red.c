...
void PWM_Red_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_Red_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_Red_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWM_Red_CAPTURE_LSB_PTR));
    }
...
void PWM_Red_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_Red_PERIOD_LSB_PTR, period);
    #endif /* (PWM_Red_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_Red_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_Red_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_Red_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_Red_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_Red_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_Red_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_Red_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_Red_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_Red_COMPARE1_LSB_PTR));
        #endif /* (PWM_Red_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Red_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_Red_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_Red_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_Red_PERIOD_LSB_PTR));
    #endif /* (PWM_Red_UsingFixedFunction) */
}
